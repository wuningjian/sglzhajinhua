...
var PopUpChatLayer=PopUp.extend({
    ...
    initChatFrameAndContent:function(){
        ...
        //输入框
        this.textField = new ccui.TextField("输入聊天内容...","Arial", 32);
        this.textField.setContentSize(
           cc.size(inputTxtBackground.getContentSize().width,inputTxtBackground.getContentSize().height));
        this.textField.setTouchSize(
            cc.size(inputTxtBackground.getContentSize().width,inputTxtBackground.getContentSize().height));
        this.textField.setTouchAreaEnabled(true);
        this.textField.setTouchEnabled(true);
        this.textField.addEventListener(this.touchChatInputCallback);
    ...
    //点击文本输入框时回调的函数
    touchChatInputCallback:function(sender,type){
    ...
    menuCallbackFace:function(){
        ...
        for (var i = 0,j=0; i < 17; i++) {
            ...
            button.addTouchEventListener(this.menuCallbackGetFace);
    ...
    menuCallbackTacking:function(){
        ...
        button1.addTouchEventListener(this.menuCallbackGetTack);
        button1.setName("1");
        button1.attr({
            x : 25,
        ...
        button2.addTouchEventListener(this.menuCallbackGetTack);
        button2.setName("2");
        button2.attr({
            x : 25,
        ...
        button3.addTouchEventListener(this.menuCallbackGetTack);
        button3.setName("3");
        button3.attr({
            x : 25,
        ...
        button4.addTouchEventListener(this.menuCallbackGetTack);
        button4.setName("4");
        button4.attr({
            x : 25,
        ...
        button5.addTouchEventListener(this.menuCallbackGetTack);
        button5.setName("5");
        button5.attr({
            x : 25,
        ...
        button6.addTouchEventListener(this.menuCallbackGetTack);
        button6.setName("6");
        button6.attr({
            x : 25,
        ...
        button7.addTouchEventListener(this.menuCallbackGetTack);
        button7.setName("7");
        button7.attr({
            x : 25,
        ...
        button8.addTouchEventListener(this.menuCallbackGetTack);
        button8.setName("8");
        button8.attr({
            x : 25,
        ...
        button9.addTouchEventListener(this.menuCallbackGetTack);
        button9.setName("9");
        button9.attr({
            x : 25,
        ...
        button10.addTouchEventListener(this.menuCallbackGetTack);
        button10.setName("10");
        button10.attr({
            x : 25,
        ...
        button11.addTouchEventListener(this.menuCallbackGetTack);
        button11.setName("11");
        button11.attr({
            x : 25,
        ...
        button12.addTouchEventListener(this.menuCallbackGetTack);
        button12.setName("12");
        button12.attr({
            x : 25,
        ...
        button13.addTouchEventListener(this.menuCallbackGetTack);
        button13.setName("13");
        button13.attr({
            x : 25,
    ...
    //点击聊天历史按钮时回调函数，在滑动框中初始化聊天记录文本列表
    ...
    menuCallbackSend:function(){
        ...
        if(inputString!=""&&inputString!=null){
            ...
            this.textField.setPlaceHolder("输入聊天内容...");
