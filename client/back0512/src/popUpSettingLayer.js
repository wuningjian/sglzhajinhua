...
var PopUpSettingLayer=PopUp.extend({
    ...
    ctor:function() {
        ...
        console.log("g_music_key:"+g_music_key);
    ...
    initSettingSurface:function(){
        ...
        var musicToggleMenuItem=new cc.MenuItemToggle(musicOpenMenuItem,musicCloseMenuItem,this.menuMusicSettingCallback);
        ...
        var soundToggleMenuItem=new cc.MenuItemToggle(soundOpenMenuItem,soundCloseMenuItem,this.menuSoundSettingCallback);
        ...
        var chatToggleMenuItem=new cc.MenuItemToggle(chatOpenMenuItem,chatCloseMenuItem,this.menuChatSettingCallback);
        ...
        var shockToggleMenuItem=new cc.MenuItemToggle(shockOpenMenuItem,shockCloseMenuItem,this.menuShockSettingCallback);
        ...
        if(g_chat_key==BOOL.NO){
            chatToggleMenuItem.setSelectedIndex(1);
            g_chat_key=BOOL.NO;
            //cc.sys.localStorage.setItem(CHAT_KEY,BOOL.NO);
        }
        else{
            chatToggleMenuItem.setSelectedIndex(0);
            g_chat_key=BOOL.YES;
    ...
    menuMusicSettingCallback:function(sender){
        if(g_music_key==BOOL.NO){
    ...
    menuSoundSettingCallback:function(sender){
        if(g_sound_key==BOOL.NO){
            sender.setSelectedIndex(0);
            g_sound_key=BOOL.YES;
            cc.sys.localStorage.setItem(SOUND_KEY,BOOL.YES);
    ...
    menuChatSettingCallback:function(sender){
        if(g_chat_key==BOOL.NO){
            sender.setSelectedIndex(0);
            g_chat_key=BOOL.YES;
            cc.sys.localStorage.setItem(CHAT_KEY,BOOL.YES);
    ...
    menuShockSettingCallback:function(sender){
